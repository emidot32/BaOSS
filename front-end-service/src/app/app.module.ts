...
import { OrdersAndInstancesComponent } from './orders-and-instances/orders-and-instances.component';
...
const homeAthComponents: Routes = [
    ...
    {path: 'orders-and-instances', component: OrdersAndInstancesComponent},
