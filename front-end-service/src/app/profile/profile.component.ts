...
import {Address, Delivery, User} from '../_models/interface';
...
export class ProfileComponent implements OnInit {
    ...
    confirmAddingAddress() {
        ...
        this.userService.addAddressForUser(this.user, address)
            .subscribe(data => {
                this.user = data;
    ...
    deleteAddress() {
        if (this.addressSelected == null) {
            this.toaster.error('Select the address!');
        } else {
            this.userService.removeAddressForUser(this.user.id, this.addressSelected.addressId)
                .subscribe(data => {
                    this.user = data;
