...
public class OffersController {
    ...
    public InternetOfferDto getInternetOffer(@RequestParam("internetOfferId") String internetOfferId) {
        return internetOfferService.getInternetOffer(internetOfferId);
    }
    ...
    DtvOfferDto getDtvOffer(@RequestParam("dtvOfferId") String dtvOfferId) {
        return dtvOfferService.getDtvOffer(dtvOfferId);
    }
    ...
    @GetMapping("/tariff")
    TariffDto getTariff(@RequestParam("tariffId") String tariffId) {
