...
public class ValidationService {
    ...
    public boolean emailValidation(String email) {
        ...
        if (matcher.matches()) return stringValidation(email, 2, 30);
    ...
    public boolean userValidation(UserDto userDto, boolean validatePassword) {
        if (validatePassword)
            return loginValidation(userDto.getLogin()) &&
