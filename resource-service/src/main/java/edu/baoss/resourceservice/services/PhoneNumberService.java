...
public class PhoneNumberService {
    ...
    public PhoneNumber reserveSimCard(PhoneNumber phoneNumber) {
    ...
    public PhoneNumber getPhoneNumber(String phoneNumberStr) {
        return phoneNumberRepository.getByPhoneNumber(phoneNumberStr).orElseThrow(NoPhoneNumberFoundException::new);
    }
}
